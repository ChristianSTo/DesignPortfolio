...
const HouseLitMaterial = shaderMaterial(
  {
    // Color Uniforms
    uLitColor: new THREE.Color("#fff"),
    uShadeColor: new THREE.Color("#fff"),
...
extend({ HouseLitMaterial }); // Register the material
// Use the HouseLitMaterial defined above
function HouseMaterial({ lightPosition, ...props }) {
  ...
  return (
    <HouseLitMaterial
      ...
      uBaseColor={new THREE.Color("#fff")}
      uHighlightColor={new THREE.Color("#FFFFFF")}
